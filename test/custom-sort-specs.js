...
const [oddEvenSort, validAnagrams, reverseBaseSort,
       frequencySort, ageSort] = require("../custom-sorts.js");

describe ('Custom Sorting Algorithms', function () {


  it('sorts odds before evens', function () {
  ...
  it('checks if two strings are anagrams of each other', function () {
  ...
  it('sorts numbers by reverse base', function () {
  ...
  it('sorts numbers by the amount of times they occur in the array', function () {
